...
//     version 1.11.2
//     from Assets/AirplanePhysics/Code/Scripts/Input/AirplaneActions.inputactions
//
...
public partial class @AirplaneActions: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @AirplaneActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""AirplaneActions"",
    ""maps"": [
        {
    ...
    ~@AirplaneActions()
    {
        UnityEngine.Debug.Assert(!m_AirplaneControls.enabled, "This will cause a leak and performance issues, AirplaneActions.AirplaneControls.Disable() has not been called.");
    }
    ...
    {
        private @AirplaneActions m_Wrapper;
        public AirplaneControlsActions(@AirplaneActions wrapper) { m_Wrapper = wrapper; }
